import "./irrigation-map-card.js?v=157";
...
class GardenMapCard extends HTMLElement {
  ...
  render() {
    ...
    root.innerHTML = `
      <ha-card class="${cardClasses}">
        <link rel="stylesheet" href="${this.resolveAsset("garden-styles.css?v=130")}">
        <style>
  ...
  rendererOptions() {
    ...
    return {
      ...
      robotImage: this.config.robot_image || this.config.robotImage || this.resolveAsset("robot.png?v=130"),
...
window.customCards.push({
  ...
  description: "Közös Anthbot és locsolórendszer térképkártya – v157",
});
